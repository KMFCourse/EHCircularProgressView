...
@interface EHCircularProgressLayer : CALayer
...
@implementation EHCircularProgressLayer
...
@interface EHCircularProgressView ()<CAAnimationDelegate>

@end

@implementation EHCircularProgressView

+ (void) initialize
{
    if (self == [EHCircularProgressView class]) {
        EHCircularProgressView *circularProgressViewAppearance = [EHCircularProgressView appearance];
...
+ (Class)layerClass
{
    return [EHCircularProgressLayer class];
}

- (EHCircularProgressLayer *)circularProgressLayer
{
    return (EHCircularProgressLayer *)self.layer;
}
