...
Pod::Spec.new do |s|
  ...
  s.version      = "0.1.0"
  s.summary      = "EHCircularProgressView for Project Homepage."
 ...
 a simple way to add Controllers and show in tableview
  ...
  s.homepage     = "https://github.com/KMFCourse/EHCircularProgressView"
  ...
  # Or just: s.author    = "赵云鹏"
  # s.authors            = { "赵云鹏" => "807536782@qq.com" }
  # s.social_media_url   = "http://twitter.com/赵云鹏"
  ...
  s.source_files  = "ZYP_HomeViewController/*.{h,m}"
